(function () {
    ...
    class Chocolat {
      ...
      markup() {
        ...
        this.elems.left.setAttribute('class', 'chocolat-left fal fa-chevron-left pl-4');
        ...
        this.elems.right.setAttribute('class', 'chocolat-right fal fa-chevron-right pr-4');
        this.elems.center.appendChild(this.elems.right);
        this.elems.bottom = document.createElement('div');
        this.elems.bottom.setAttribute('class', 'chocolat-bottom bg-transparent');
        this.elems.layout.appendChild(this.elems.bottom);
        this.elems.close = document.createElement('span');
        this.elems.close.setAttribute('class', 'chocolat-close icon-close p-4');
