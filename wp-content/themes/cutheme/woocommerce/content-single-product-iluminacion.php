...
if ($product->get_type() == 'variable') {
    ...
    // Hacemos un array solo con la parte que nos interesa de lo que nos devuelve woocomm (attributes)
    foreach($variations as $variation) {

        array_push($custom_variations, $variation['attributes']);
    }

    // Hacemos un array cambiando los indices de texto por numericos (para hacerlos coincidir con los <selects>)
    $pol_variations = array();

    foreach($custom_variations as $custom_variation) {

        $pol_variation = array();
        $keys = array_keys($custom_variation);
        foreach($custom_variation as $index => $attribute) {
            $num_index = array_search($index, $keys);
            $pol_variation = array_push_assoc($pol_variation, $num_index, $attribute);
        }
        array_push($pol_variations, $pol_variation);   
    }

    console_log('pol_variations');
    sort($pol_variations);
    console_log($pol_variations);
}
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
            ...
            <div class="container-fluid mb-lg-5 mt-lg-5 mt-3 mb-3 ">
                <div class="row justify-content-betwwen">
                    <div class="col-lg-6 col-12">
                        ...
                        <div id="sectioautores">
                            ...
                            <?php
                             ...
                             ?>
                            <?php foreach( $autores as $featured_post ): 
                                $permalink = get_permalink( $featured_post );
                                $title = get_the_title( $featured_post );?>

                            <a class="pr-2 mainautor" href="<?php echo $permalink; ?>">
                                <?php echo $title.$ponercoma;?>
                    ...
                    <div class="col-lg-6 col-12 text-right">
                        <!-- <p
                            class="<?php //echo esc_attr( apply_filters( 'woocommerce_product_price_class', 'price' ) ); ?> mb-0 price-range">
                        ...
                        <div class="btn-comprar-1">
                            ...
                            <button
                                class="add-to-cart-var text-underline p-0 bg-transparent br-0 border-0 color-custom-black fs-0875"><?php _e('Añadir a la cesta', 'santa-cole') ?></button>
                            <?php } ?>
                        </div>
                        <?php } else { ?>
                        <div class="btn-comprar-1">
    ...
    <section class="mb-lg-5 mb-0 pb-lg-5">
        <div class="wrapper">
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-lg-7 col-12 d-flex flex-column justify-content-center wrapper-right summary entry-summary mb-lg-0 mb-4">
                        <?php
					/**
					...
					?>
                        <hr class="w-100 border-light-grey2">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-5 pl-0">
                                    <span
                                        class="text-underline color-grey-light2 fs-075 d-block mb-2 cursor-pointer open-modal-pago">
                                        <?php _e('Pago seguro', 'santa-cole') ?>
                                    </span>
                                    <a href="#" id="seguro_de_envio"
                                        class="text-underline color-grey-light2 fs-075 d-block mb-2 open-modal-envio">
                                        <?php _e('Seguro de envío incluido', 'santa-cole') ?>
                                    </a>
                                    <a href="#"
                                        class="text-underline color-grey-light2 fs-075 d-block mb-2 open-modal-plazos">
                                        <?php _e('Opción de pago a plazos', 'santa-cole') ?>
                                    </a>
                                </div>
                                <div class="col-lg-7 pl-lg-3 pl-0 pr-0 text-md-right">
                                    <span class="color-grey-light2 fs-075">
                    ...
                    <div class="col-lg-5 col-12 pl-lg-3 pl-0">
                    ...
                    <div class="col-12">
                        <div class="accordion" id="accordionEspecificaciones">
                            <div class="card" id="especitab">
                                ...
                                <div class="d-flex justify-content-between align-items-center card-header border-bottom bg-transparent px-0"
                                    id="heading-1" data-toggle="collapse" data-target="#collapse-1"
                                    aria-expanded="false" aria-controls="collapse-1">
                                    <p class="fs-11 mb-0"><?php _e('Especificaciones', 'santa-cole') ?> </p>
                                                ...
                                                <div class="tab-pane <?php echo $active ?>" id="model-00-tab"
                                                    ...
                                                    <div class="row px-0">
                                                        ...
                                                        <div class="col-12 col-md-4  mb-4 mb-md-0">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-block pr-lg-4 pr-3">
                                                                    <span class="fs-11 <?php echo $valor;?>"></span>
                                                                </div>
                                                                <?php endforeach; ?>
                                                        ...
                                                        <div class="col-12 col-md-4">
                                                            <h4 class="mb-4 fw-400 fs-1">
                                                                <?php _e('Fuentes de luz', 'santa-cole') ?>
                                                            </h4>
                                                            <div class="fs-09 color-custom-black formato">

                                                                <?php if (comprar()) { ?>
                                                                <!-- CE -->
                                                                <?php the_field('fuentes_de_luz'); ?>
                                                                <?php }else { ?>
                                                                <!-- UL -->
                                                                <?php the_field('fuentes_de_luz_ul'); ?>
                                                                <?php  } ?>
                                                            </div>
                                                        </div>
                            ...
                            <div class="card" id="descargastab">
                                ...
                                <div class="d-flex justify-content-between align-items-center card-header collapsed border-bottom bg-transparent px-0"
                                    ...
                                    <p class="fs-11 mb-0"><?php _e('Descargables', 'santa-cole') ?></p>
                                    <span class="fal fa-chevron-down fs-12"></span>
                                </div>
                                <div id="collapse-2" class="collapse" aria-labelledby="heading-2"
                                    ...
                                    <div class="card-body px-0">
                                        <div class="container-fluid px-0">
                                                ...
                                                <ul class="col-5 col-md-4 col-lg-6 nav nav-tabs d-flex justify-content-start justify-content-md-start mb-3 flex-column flex-md-row mb-4"
                                                    ...
                                                    <li class="nav-item mr-4 ml-0 mb-2" role="tabpanel-des">
                                                        <input id="mercado-ce" type="radio" class="input-radio"
                                                            name="model-descargable-select-mercado" value="mercado-ce"
                                                            checked="">
                                                    ...
                                                    <li class="nav-item mr-4 ml-0 mb-2" role="tabpanel-des">
                                                        <input id="mercado-ul" type="radio" class="input-radio"
                                                            name="model-descargable-select-mercado" value="mercado-ul">
                                            ...
                                            <!-- Tabs -->
                                            <div class="tab-content 222222" id="descargabletancontent">
                                                ...
                                                <div class="tab-pane fade show active"
                                                    ...
                                                    <div class="tab-content" id="mercadoselectcontent">
                                                        ...
                                                        <div class="tab-pane fade show active" id="mercado-ce-tab"
                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                <a href="<?php the_sub_field('url_del_archivo'); ?>"
                                                                    class="card-descargas-new" target="_blank">

                                                                    <p class="mb-0">
                                                                        <?php the_sub_field('nombre_del_archivo'); ?><br>
                                                                        <span
                                                                            class="color-grey-light2 mb-0 text-uppercase topmvov">
                                                                            <?php
                                                        ...
                                                        <div class="tab-pane fade" id="mercado-ul-tab" role="tabpanel"
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex justify-content-between align-items-center card-header collapsed border-bottom bg-transparent px-0"
                                    ...
                                    <p class="fs-11 mb-0"> <?php _e('Adaptaciones de producto', 'santa-cole') ?></p>
                                    <span class="fal fa-chevron-down fs-12"></span>
                                </div>
                                                    ...
                                                    <div class="product-contet mt-lg-3 mt-2">
                                                        <div class="d-block">
                                                            <p class="mb-2 fs-1 color-black">
                                                                <?php echo $TitleRecambios; ?>
                                                            </p>
                                                            <!-- <p class="fs-08 color-grey-light3">Acabado</p> -->
                                                        </div>
                                                        <div class="d-block">
                                                            <p
                                                                class="<?php echo esc_attr( apply_filters( 'woocommerce_product_price_class', 'price' ) ); ?> parrilla-price fs-1 mb-2">
                                                            ...
                                                            <a href="<?php echo get_site_url(); ?>/<?php echo $language_actuall;
                                                                ...
                                                                <?php _e('Añadir a la cesta', 'santa-cole') ?>
                                                            </a>
                                                            <?php } ?>
    ...
    <?php
        ...
        if( $values ) {
            ...
            // Comprobación de si el producto variable tiene algun recambio en sus modelos disponibles
            // LA HE MEJORADO PARA QUE SE ENTIENDA MEJOR
            foreach ($values as $term) {

                if (get_field('codigos_unicos_de_recambios', 'term_' . $term->term_id)) {
                    $variable_recambios = true;
                }else {
                    $variable_recambios = false;
                }
            }
    ?>

    <seccion>
        <div class="wrapper bg-beige variable">
            <div class="container-fluid pb-5 pt-3">
                <div class="row py-5 sectionproducts">
                    <div class="col-12">
                        <div class="accordion" id="accordionEspecificaciones">
                                                    ...
                                                    <div class="row px-0">
                                                        ...
                                                        <div class="col-12 col-md-4">
                                                            ...
                                                            <div class="color-custom-black fs-09 formato">
                                                                ...
                                                                <?php if (comprar()) { ?>
                                                                <?php the_field('fuentes_de_luz', 'term_' . $term->term_id); ?>
                                                                <?php }else { ?>
                                                                <?php the_field('fuentes_de_luz_ul', 'term_' . $term->term_id); ?>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="container-fluid px-0">
                                            ...
                                            <div class="tab-content" id="descargabletancontent">
                                                ...
                                                <div class="tab-pane fade show <?php echo $active ?>"
                                                    id="model-descargable-<?php echo $i ?>-tab-simple" role="tabpanel"
                                                    ...
                                                    <div class="tab-content-inter-ul"
                                                        ...
                                                        <div class="tab-pane-inter-ul" id="mercado-ul-tab"
                                                            role="tabpanel-inter-ul" aria-labelledby="mercado-ul-tab">
                                                            <div class="d-flex flex-wrap">
                                                                <?php if (comprar()) { ?>
                                                    ...
                                                    <div class="tab-pane <?php echo $active ?>"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <?php 
                                                                ...
                                                                //print_r2($SKUsRecambios);
                                                                $arrayRecambios = explode(",", $SKUsRecambios);
                                                                //print_r2($arrayRecambios);
                                                                foreach ($arrayRecambios as $Sku) : 
                                                                    $language_actuall = apply_filters( 'wpml_current_language', NULL ); 
                                                                    $post_id = IDProduct_By_Sku_Mich($Sku,$language_actuall);
                                                                if ($post_id != 000) :
            ...
            <div class="container-fluid mt-lg-5 mt-3">
                ...
                <div class="row pt-md-3 justify-content-between">
                    <div class="col-12 col-md-6 mb-4 mb-md-0">
                        ...
                        <?php
                        // Check rows exists.
                        if( have_rows('premios') ): ?>
                        <div class="content-premio">
                            <a href="#" class="fs-08 text-underline ">
                                <?php while( have_rows('premios') ) : the_row(); ?>
                                <span class="pr-3"><?php the_sub_field('nombre_del_premio') ?></span>
                                <?php endwhile; ?>
                            </a>
                        </div>

                        <div class="modalnav" id="ModalPremios">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-between px-0">
                                        <span
                                            class="d-block fs-1"><?php _e('Premios del producto', 'santa-cole') ?></span>
                                    ...
                                    <?php while( have_rows('premios') ) : the_row(); ?>
                                    <div class="col-12">
                                        <img src="<?php the_sub_field('imagen_premio') ?>"
                                            alt="<?php the_sub_field('nombre_del_premio') ?>">
                                        <span class="d-block"><?php the_sub_field('nombre_del_premio') ?></span>
                                        <div class="formato">
                                            <?php the_sub_field('descripcion_del_premio') ?>
                                        </div>
                                    </div>
    ...
    <?php 
        /*
            OCULTAMOS LA SECCION DE PRODUCTOS EN LUGARES 
    ...
    <section id="productos-en-lugares">
        <div class="wrapper py-5">
            <div class="container-fluid">
                <div class="row pt-4">
                    <div class="col-lg-6 col-md-6 ">
                        <h3 class="mb-4 fs-125 fw-400"> <?php _e('Producto en lugares', 'santa-cole') ?></h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <seccion>
        <div class="wrapper bg-beige py-5">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <h3 class="fw-400 fs-125"><?php _e('Diseño de', 'santa-cole') ?></h3>
                        <hr class="border-light-grey">
                    </div>
                </div>
                    ...
                    <div id="autor-container">
                        ...
                        <div class="autor-item d-flex col-12 mb-5  mb-md-0">
                            ...
                            <div class="autor-description col-12 mt-2 pt-2 mt-lg-4 pt-lg-4 px-0">
                                <p class="fs-1 mb-4"><?php the_title(); ?></p>
                                <div class="fs-0875 color-custom-black formato mb-4">
                                    <?php the_field( 'texto_destacado' ); ?>
                                </div>
                                <a href="<?php the_permalink(); ?>" title=""
                                    class="fs-075 text-underline color-grey-light2"><?php _e('Más información', 'santa-cole') ?></a>
                            </div>
                        </div>
                        <?php endforeach; ?>
    ...
    <section class="py-lg-5 py-4">
        ...
        <div class="wrapper-left">
            <div class="container-fluid px-lg-1 pb-5">
                <div class="row">
...
jQuery(document).ready(function($) {
    ...
    var waitForClass = function(selector, clase, callback) {
        if (!$(selector).hasClass(clase)) {
            console.log('ahora')
            callback();
        } else {
            setTimeout(function() {
                waitForClass(selector, clase, callback);
            }, 100);
        }
    };

    // Adequamos el array de php a js
    let pol_variations = <?php echo json_encode($pol_variations); ?>;
    pol_variations = JSON.parse(JSON.stringify(pol_variations));

    console.log(pol_variations)

    options = []
    sub_options = []

    // Generación de array con las opciones disponibles de cada atributo
    if (pol_variations.length > 0) {

        for (let i = 0; i < pol_variations[0].length; i++) {

            sub_options = []
            for (let j = 0; j < pol_variations.length; j++) {

                // If not included, push
                if (!sub_options.includes(pol_variations[j][i])) {
                    sub_options.push(pol_variations[j][i])
                }
            }
            options.push(sub_options)
        }
    }


    // Arrancamos la función después de asegurar que el plugin (nice-select) ya se ha iniciado
    waitForEl(".nice-select", function() {
        if (pol_variations.length > 0) {
            //start_manager();

            // Replace '-' PREFIJO JUAN PRODUCTOS MODELO
            $(".variations tr span.current")[0].innerText = $(".variations tr span.current")[0]
                .innerText.split('-')[0]
            let options = $(".variations tr nice-custom-select-0 ul li")
            options.each(function() {

                $(this)[0].innerText = $(this)[0].innerText.split('-')[0]
            })
        }
    });
    ...
    function load_options() {
        ...
        filtered_array = pol_variations;
        let included = ''

        $("[data-value]").show()

        let visible_tr = $('.variations tr:not([style*="display: none"])');

        visible_tr.each(function(index, element) {

            console.log('EMPIEZA FOR POR CADA TR VISIBLE, POR AHORA EL NUMERO ' + index +
                ' DE UN TOTAL DE ' + visible_tr.length)

            if (index < visible_tr.length - 1) {

                key = $(`.tr-variacion-${index}`).attr('class').split('-').pop()
                value = $(`.tr-variacion-${index} li.selected`).data('value')
                console.log('KEY ')
                console.log(key)
                console.log('VALUE ')
                console.log(value)
                console.log('BEFOREEEE ')
                filtered_array = filter_array_by_value(key, value, filtered_array)

                let result = filtered_array.filter(function(variation) {
                ...
                console.log('ARRAY (RE)FILTRADO CON EL VALOR DEL SELECT NUMERO' + index)
                console.log(result)
                console.log('ARRAY DE OPCIONES DE CADA ATRIBUTO ')
                console.log(options)



                options[index + 1].forEach(function(option_value) {
                    ...
                    result.forEach(function(result_row, index_row) {

                        if (result_row.includes(option_value)) {
                            console.log('El valor ' + option_value +
                                ' SÍ se incluye en la fila ' + result_row +
                                ' de la variacion ' + index_row)
                            included = true
                        }
                        console.log('option_value ' + option_value)
                        console.log('result_value ' + result_row)
                    })

                    if (!included) {

                        $(`[data-value="${option_value}"]`).hide()
                    }
    ...
    function load_defaults(key, value) {

        //filtered_array = filter_array_by_value(key, value, pol_variations)

        let visible_tr = $('.variations tr:not([style*="display: none"])')

        visible_tr.each(function() {
            console.log('bixx')
            $(this).find('li').removeClass('selected')
            let current = $(this).find(".current")[0].innerText
            $(this).find('li').not('[style*="display: none"]').first().next().addClass('selected')
                .text(current)
    ...
    /**
    * Recibe un array de variaciones previamente filtrado, y ¡por cada variacion! del mismo, comprueba que por un ¡mismo atributo!,
    *   no exista un campo vacío de algun otro atributo.
    * Si por un mismo atributo, encuentra un campo vacío de algun otro atributo, esconde el select asociado a este último
    */
    function hide_selects_empty_attributes(key, value) {

        filtered_array = filter_array_by_value(key, value, pol_variations)

        // Por cada atributo
        for (let k = 0; k < n_atributos; k++) {

            console.log('/DEBUG_hide_selects_empty_attributes: ATRIBUTO ' + k)
            ...
            for (let j = 0; j < filtered_array.length; j++) {
                ...
                console.log('/DEBUG_hide_selects_empty_atributes: Valor de la fila ' + j +
                    ' y del atributo ' + k + ' :')
                console.log(filtered_array[j][k])

                if (filtered_array[j][k] != '') {

                    atributo_vacio = false
                }

                // Caso de esconder <option>'s si necesario
                if (j + 1 < filtered_array.length) {

                    // Si un atirbuto está vacío pero el mismo de la siguiente variación no
                    if (filtered_array[j][k] == '' && filtered_array[j + 1][k] != '') {
                        console.log('WARNING')
                        console.log($(`.tr-variacion-${key} li`).children(k))
                    }
                }
            }
            ...
            if (atributo_vacio) {
                ...
                console.log('/DEBUG_hide_selects_empty_attributes: El atributo ' + k + ' esta vacio')
                console.log('/DEBUG_hidden: Se va a esconder el tr con "id" ' + k)
    ...
    /**
    * Recibe una pareja clave<->valor y recoge aquellas filas del array de variaciones que coinciden con esos valores
    * -> key : Índice del atributo por el cual filtrar
    * -> value : Valor del atributo por el cual filtrar
    * <- result : Array filtrado con los valores anteriores
    */
    function filter_array_by_value(key, value, filtered_array) {

        let result = filtered_array.filter(function(variation) {

            if (variation[key] == value) {
                return true
            }
        })

        console.log('/DEBUG_filter_array_by_value: Filtered array by KEY: ' + key + ' and VALUE: ' + value)

        return result
    }

    /**
    * Por cada atributo, mira los valores de las variaciones del atributo hijo (recurrentemente) y si son todos iguales esconde el select que los muestra.
    */
    function hide_same_attribute() {

        // Mostramos todos los selects antes de (alomejor) esconder alguno de ellos
        $(".variations tr").show()

        filtered_array = pol_variations;

        for (let i = 0; i < n_selects - 1; i++) {

            key = i
            value = $(`.tr-variacion-${i} li.selected`).data('value')

            filtered_array = filter_array_by_value(key, value, filtered_array)

            // Se va a mirar el siguiente atributo al seleccionado en el <select>
            key++

            // Debug para ver el filtrado del array a cada iteración (cada vez más reducido)
            console.log("/DEBUG_hide_same_attribute: Array filtrado por " + i + " vez: ")
            console.log(filtered_array)

            let valor_aux = ''
            let iguales = undefined

            for (let i = key; i <= n_atributos; i++) {

                // Guardamos el valor del atributo como referencia para los demás
                filtered_array.every(function(variation) {
                    if (variation[i] != '') {
                        valor_aux = variation[i]
                ...
                console.log("/DEBUG_hide_same_attribute: valor_aux = " + valor_aux)
                ...
                for (let j = 0; j < filtered_array.length; j++) {
                    ...
                    if (valor_aux == '' || valor_aux == undefined) {
                        iguales = false
                    }
                    if (filtered_array[j][i] != valor_aux) {
                        iguales = false
                    }
                }
                if (iguales) {

                    console.log('/DEBUG_hide_same_attribute: El atributo con indice: ' + (i) + ' tiene el mismo valor en todas las variaciones del anterior array filtrado:')
                    // Quitamos la clase selected de la ultima seleccion (anterior seleccion, ya sea modelo o wahtever)
                    $(`.tr-variacion-${i} li.selected`).removeClass('selected')
                    
                    // Dejamos seleccionado el valor del select que se va a esconder (única opcion disponible)
                    $(`.tr-variacion-${i} [data-value="${valor_aux}"]`).addClass('selected')
                    $(`.tr-variacion-${i}`).hide()
                }
            }
        }
    ...
    function hide_not_included_options() {

        let value = $(`.tr-variacion-${0} li.selected`).data('value')
        console.log('bal ' + value)

        let filtered_array = filter_array_by_value(0, value, pol_variations)
        console.log('filteer')
        console.log(filtered_array)

        for (let i = 1; i < n_selects - 1; i++) {

            let options = $(`.tr-variacion-${i} li`)
            options.show()
            
            let atribute_values = []

            for (let j = 0; j < filtered_array.length - 1; j++) {

                atribute_values.push(filtered_array[j][i])
            }

            // Reemplazar valor mostrado por uno que exista (seguridad)
            let value = $(`.tr-variacion-${i} li.selected`).data('value')
            console.log('bal ' + value)

            if (!atribute_values.includes(value)) {

                $(".variations tr span.current")[i].innerText = atribute_values[i]
            }

            options.filter(function() {

                // Caso de 'escoge una opcion'
                if ($(this).data('value') != '') {
                    let option_value = $(this).data('value')

                    let included = atribute_values.includes(option_value)
  
                    console.log('values ')
                    console.log(atribute_values)
    ...
    function filter_and_hide_options(i_selected) {

        // We need to know which select has been clicked
        let n_visible_selects = $(".variations tr:visible").length
        // Add 1 due to the counter that starts in 0
        i_selected++

        let filtered_array = pol_variations
        let value = undefined
        let options = undefined
        let option = undefined
        let filtered_options = []

        options = $('.variation li')
        options.show()

        if (i_selected < n_visible_selects) {

            // Si estamos aqui significa que hay un select o más por debajo del select al que se ha hecho click
            let selects_por_venir = n_visible_selects - i_selected

            // Substract 1 due to select tr
            i_selected--

            for (let i = 0; i <= i_selected; i++) {

                value = $(`.tr-variacion-${i} li.selected`).data('value')
                filtered_array = filter_array_by_value(i, value, filtered_array)
            }

            for (let i = i_selected; i < n_visible_selects; i++) {

                // Pels selects que queden més avall:
                options = $(`.tr-variacion-${i} li`)
                options.each(function() {
                ...
                if (value != '') {
                    console.log('array filtrat: ' + filtered_array)

                    for (let j = 0; j < filtered_array[i].length; j++) {

                        filtered_options.push(filtered_array[j][i])
                    }

                    console.log(filtered_options)

                    if (!filtered_options.includes(value)) {
                        $(this).hide()
                    }
                }
    ...
    function custom_nice_select(clicked_li) {

        // Si se llama al hacer click en un select
        if (clicked_li != '') {

            // Descubrimos en que select se ha hecho click (el padre)
            i_selected = clicked_li.parents('tr').attr('class').split('-').pop()
            console.log('/DEBUG_start: Clickrun -> i selected')
            console.log(i_selected)

            // Agarramos el texto (data-value) del item en el que se ha hecho click (<option>)
            text = $(clicked_li).data('value')
            console.log('/DEBUG_start: Clickrun -> text')
            console.log(text)


            // Si la opción seleccionada tiene un valor concreto, ejecutar la lógica
            if (text != '') {

                hide_selects_empty_attributes(i_selected, text)

                waitForClass(`.tr-variacion-${i_selected} li.focus`, 'selected', function() {

                    hide_same_attribute()
                    //load_options()
                    if (i_selected == 0) {
                        //load_defaults(i_selected, text)
                    }
                    hide_not_included_options()
                    //filter_and_hide_options(i_selected)
                })

                // SELF ACLARATION: Aunque se haga para todos los atributos, se mira hacia adelante (hijos), ITS OK! :)
                /*for (let i = 0; i < n_selects - 1; i++) {

                    // If Has no Class
                    waitForClass($(`.tr-variacion-${i} li.selected`), 'selected', function() {
                ...
                // Si se selecciona 'Elige una opción' en el primer select, los que estan por debajo se muestran de nuevo
                if ($(clicked_li).parents('tr').attr('class').split('-').pop() == 0) {

                    $(clicked_li).parents('tr').siblings().show()
                }
            }

            // Si se llama automaticamente al cargar la página
        } else {

            let i_selected = $('.tr-variacion-0').attr('class').split('-').pop()
            console.log('/DEBUG_start: Autorun -> i selected')
            console.log(i_selected)

            text = $(`.tr-variacion-${i_selected} li.selected`).data('value')
            console.log('/DEBUG_start: Autorun -> text')
            console.log(text)
    ...
    function start_manager() {
        ...
        // Guardaremos el numero del select padre de la opción clickeada (o el 0 por defecto al cargar la página)
        i_selected = ''

        // Guardaremos el texto de la opcion clickeada (o el 0 por defecto al cargar la página)
        text = ''

        // Array que nos sirve para guardar solo aquellas variaciones de producto segun la opcion seleccionada en cualquier select
        // Facilita la comprensión del codigo y posiblemente reduzca el tiempo de ejecución del algoritmo
        filtered_array = undefined

        // Guardamos el número de selects que hay
        n_selects = $(".variations tr").length

        // Guardamos el número de atributos de las variaciones [Tiene el mismo valor que el anterior pero facilita la comprensión del código]
        n_atributos = pol_variations[0].length

        // Llamada al algoritmo al cargar la página (autorun)
        custom_nice_select('')

        // Llamada al algoritmo al detectar un click en los selects/opciones (clickrun)
        $(".variations tr .nice-select li").click(function() {

            custom_nice_select($(this))
        })
    }

    let open_acordeon = window.location.hash

    switch (open_acordeon) {

        case '#descargablestab':
            $("#heading-1").addClass('collapsed')
            $("#collapse-1").removeClass('show')
            $("#heading-2").removeClass('collapsed')
            $("#collapse-2").addClass('show')
            break;

        case '#adaptacionestab':
            $("#heading-1").addClass('collapsed')
            $("#collapse-1").removeClass('show')
            $("#heading-3").removeClass('collapsed')
            $("#collapse-3").addClass('show')
            break;

        case '#recambiostab':
            if ($("#heading-4").length > 0) {
                $("#heading-1").addClass('collapsed')
                $("#collapse-1").removeClass('show')
                $("#heading-4").removeClass('collapsed')
                $("#collapse-4").addClass('show')

                // Scroll to #recambiostab
            }
            break;
    ...
    // Remove shareaholic menu
    waitForEl('.shareaholic-canvas', function() {
