...
<div class="u-columns col2-set" id="customer_login">
    <ul class="nav nav-pills mb-lg-5 mb-4" id="session-tab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link px-0 active" id="log-pills-login-tab" data-toggle="pill" href="#log-pills-login"
                role="tab" aria-controls="log-pills-login"
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link px-0" id="reg-pills-register-tab" data-toggle="pill" href="#reg-pills-register"
                role="tab" aria-controls="reg-pills-register"
                aria-selected="false"><?php _e('Registrarse', 'santa-cole') ?></a>
        </li>
        <?php endif; ?>
    </ul>
    <div class="tab-content" id="session-tabContent">
        <div class="tab-pane active" id="log-pills-login" role="tabpanel" aria-labelledby="log-pills-login-tab">
            <div class="u-column1">
...
class="required">*</span></label> -->
                    ...
                    <p class="form-row">
                        ...
                        <button type="submit"
                            class="woocommerce-button button woocommerce-form-login__submit bg-custom-black text-white px-lg-5 px-4 py-2 border-black"
                            name="login"
        ...
        <?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
        <div class="tab-pane " id="reg-pills-register" role="tabpanel" aria-labelledby="reg-pills-register-tab">
            <div class="u-column2">
...
class="required">*</span></label> -->
                    ...
                    <p class="woocommerce-form-row form-row">
                        ...
                        <button type="submit"
                            class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit bg-custom-black text-white px-lg-5 px-4 py-2 border-black"
                            name="register"
