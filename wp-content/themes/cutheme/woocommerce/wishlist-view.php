	...
	if ( $wishlist && $wishlist->has_items() ) :
        ...
        <tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>"
            ...
            <td class="product-thumbnail">
                ...
                <a
                    href="<?php echo esc_url( get_permalink( apply_filters( 'woocommerce_in_cart_product', $item->get_product_id() ) ) ); ?>">
            ...
            <td class="product-add-to-cart">
                ...
                <a href="<?php echo esc_url( $item->get_remove_url() ); ?>" class="remove_from_wishlist button"
                    title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'yith-woocommerce-wishlist' ) ) ); ?>"><?php esc_html_e( 'Remove', 'yith-woocommerce-wishlist' ); ?></a>
                <?php endif; ?>
            ...
            <td class="product-arrange ">
                ...
                <input type="hidden" name="items[<?php echo esc_attr( $item->get_product_id() ); ?>][position]"
        ...
        <tr>
            <td colspan="<?php echo esc_attr( $column_count ); ?>" class="wishlist-empty">
                <div class="d-block">
                    <span class="fs-1-5 icon-favoritos-custom text-center"></span>
                </div>
